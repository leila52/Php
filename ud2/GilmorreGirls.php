...
<body>
    ...
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (isset($_FILES["archivo"]) && $_FILES["archivo"]["error"] == 0) {
                $archivoSubido = $_FILES["archivo"]["name"];
                $rutaArchivo = "uploads/" . basename($archivoSubido); // Asegúrate de que exista la carpeta 'uploads'
                ...
                // Verifica el error específico
                $errores['archivo'] = "Debes subir un archivo.";
                if (isset($_FILES["archivo"])) {
                    $errores['archivo'] .= " Código de error: " . $_FILES["archivo"]["error"];
                }
            }
            ...
            function muestraResumen($nombre, $primeravez, $cafe, $preferencia, $personajes, $temporadas, $ciudad, $comida, $cita, $episodio, $calificacion, $comentarios) {
                ...
                if ($archivoSubido) {
                    ...
                    echo "<p>Nombre del archivo: " . $archivoSubido . "</p>";
                    echo "<p>Tamaño del archivo: " . $_FILES["archivo"]["size"] . " bytes</p>";
                    echo "<p>Ruta del archivo: " . $rutaArchivo . "</p>";
                    echo '<p><a href="' . $rutaArchivo . '" download>Descargar archivo</a></p>';
                }
            ...
            if (empty($errores)) {
                ...
                muestraResumen($nombre, $primeravez, $cafe, $preferencia, $personajes, $temporadas, $ciudad, $comida, $cita, $episodio, $calificacion, $comentarios, $archivoSubido, $rutaArchivo);
            }
        }
        ?>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div>
            ...
            <span style="color:red"><?= $errores['archivo'] ?? '' ?></span>
        </div>
